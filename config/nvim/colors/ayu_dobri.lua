...
local colors = {
  ...
  -- WezTerm Integration
  wez_top = "#0f0c29",        -- Matches wezterm's tab_bar background
  wez_top_active = "#231518", -- Warm chocolate-rose background
  white = "#ffffff",
}
...
hl("FloatTitle", { fg = colors.accent, bg = "NONE", bold = true })
...
hl("Folded", { fg = colors.comment, bg = "NONE" })
...
hl("StatusLineNC", { fg = colors.comment, bg = "NONE" })
hl("WinBar", { fg = colors.white, bg = "NONE", bold = true })
hl("WinBarNC", { fg = colors.comment, bg = "NONE" })
...
hl("MsgArea", { fg = colors.white, bg = "NONE" })
hl("ModeMsg", { fg = colors.white, bg = "NONE", bold = true })
...
-- Telescope
hl("TelescopeNormal", { fg = colors.fg, bg = "NONE" })
hl("TelescopeBorder", { fg = colors.border, bg = "NONE" })
hl("TelescopePromptNormal", { fg = colors.variable, bg = "NONE" })
hl("TelescopePromptBorder", { fg = colors.accent, bg = "NONE" })
hl("TelescopePromptTitle", { fg = colors.accent, bg = "NONE", bold = true })
...
hl("SnacksPicker", { fg = colors.fg, bg = "NONE" })
hl("SnacksPickerBorder", { fg = colors.border, bg = "NONE" })
hl("SnacksPickerNormal", { fg = colors.fg, bg = "NONE" })
hl("SnacksPickerBox", { fg = colors.border, bg = "NONE" })

hl("SnacksPickerInput", { fg = colors.fg, bg = "NONE" })
hl("SnacksPickerInputNormal", { fg = colors.fg, bg = "NONE" })
hl("SnacksPickerInputBorder", { fg = colors.accent, bg = "NONE" })
...
hl("SnacksPickerList", { fg = colors.fg, bg = "NONE" })
hl("SnacksPickerListNormal", { fg = colors.fg, bg = "NONE" })
hl("SnacksPickerListBorder", { fg = colors.border, bg = "NONE" })
hl("SnacksPickerListCursorLine", { fg = colors.accent, bg = colors.line_hl, bold = true })

hl("SnacksPickerPreview", { fg = colors.fg, bg = "NONE" })
hl("SnacksPickerPreviewNormal", { fg = colors.fg, bg = "NONE" })
hl("SnacksPickerPreviewBorder", { fg = colors.border, bg = "NONE" })
...
hl("SnacksDashboardFooter", { fg = colors.white })
hl("SnacksDashboardDesc", { fg = colors.white })
...
hl("BufferLineBackground", { bg = "NONE", fg = colors.comment })
hl("BufferLineBufferSelected", { bg = "NONE", fg = colors.accent, bold = true })
hl("BufferLineBufferVisible", { bg = "NONE", fg = colors.white })
hl("BufferLineSeparator", { fg = colors.wez_top, bg = "NONE" })
hl("BufferLineSeparatorSelected", { fg = colors.accent, bg = "NONE" })
hl("BufferLineSeparatorVisible", { fg = colors.wez_top, bg = "NONE" })
hl("BufferLineIndicatorSelected", { fg = colors.accent, bg = "NONE" })
hl("BufferLineModified", { fg = colors.modified, bg = "NONE" })
hl("BufferLineModifiedSelected", { fg = colors.modified, bg = "NONE" })
hl("BufferLineModifiedVisible", { fg = colors.modified, bg = "NONE" })
hl("BufferLineCloseButton", { bg = "NONE", fg = colors.comment })
hl("BufferLineCloseButtonSelected", { bg = "NONE", fg = colors.accent })
hl("BufferLineCloseButtonVisible", { bg = "NONE", fg = colors.white })

-- Diagnostic overrides to keep text colors consistent with tab state
hl("BufferLineErrorSelected", { bg = "NONE", fg = colors.accent, bold = true })
hl("BufferLineWarningSelected", { bg = "NONE", fg = colors.accent, bold = true })
hl("BufferLineInfoSelected", { bg = "NONE", fg = colors.accent, bold = true })
hl("BufferLineHintSelected", { bg = "NONE", fg = colors.accent, bold = true })

hl("BufferLineErrorVisible", { bg = "NONE", fg = colors.white })
hl("BufferLineWarningVisible", { bg = "NONE", fg = colors.white })
hl("BufferLineInfoVisible", { bg = "NONE", fg = colors.white })
hl("BufferLineHintVisible", { bg = "NONE", fg = colors.white })

hl("BufferLineError", { bg = "NONE", fg = colors.comment })
hl("BufferLineWarning", { bg = "NONE", fg = colors.comment })
hl("BufferLineInfo", { bg = "NONE", fg = colors.comment })
hl("BufferLineHint", { bg = "NONE", fg = colors.comment })

-- Tree / Sidebar Highlights
hl("NvimTreeNormal", { fg = colors.fg, bg = "NONE" })
hl("NvimTreeNormalNC", { fg = colors.fg, bg = "NONE" })
hl("NvimTreeEndOfBuffer", { fg = colors.border, bg = "NONE" })
...
hl("NeoTreeEndOfBuffer", { fg = colors.border, bg = "NONE" })
...
-- Dropbar
hl("DropBarIconUIIndicator", { fg = colors.comment, bg = "NONE" })
hl("DropBarIconUIIndicatorNC", { fg = colors.comment, bg = "NONE" })
hl("DropBarIconUISeparator", { fg = colors.comment, bg = "NONE" })
hl("DropBarIconUISeparatorNC", { fg = colors.comment, bg = "NONE" })
hl("DropBarIconUISeparatorMenu", { fg = colors.comment, bg = "NONE" })
hl("DropBarIconUISeparatorMenuNC", { fg = colors.comment, bg = "NONE" })
...
hl("DropBarCurrentContextName", { fg = colors.accent, bg = "NONE", bold = true })
