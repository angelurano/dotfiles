...
hl("NormalFloat", { fg = colors.fg, bg = colors.widget_bg })
hl("NormalNC", { fg = colors.fg, bg = colors.bg })
hl("FloatBorder", { fg = colors.border, bg = colors.widget_bg })
hl("FloatTitle", { fg = colors.accent, bg = colors.widget_bg, bold = true })
...
hl("Pmenu", { fg = colors.fg, bg = colors.suggest_bg })
hl("PmenuSel", { fg = colors.accent, bg = colors.suggest_selected, bold = true })
hl("PmenuSbar", { bg = colors.dark_bg })
hl("PmenuThumb", { bg = colors.border })
hl("StatusLine", { fg = colors.fg, bg = colors.widget_bg })
hl("StatusLineNC", { fg = colors.comment, bg = colors.dark_bg })
...
-- Git Signs / Diff
hl("DiffAdd", { fg = colors.added, bg = colors.dark_bg })
hl("DiffChange", { fg = colors.modified, bg = colors.dark_bg })
hl("DiffDelete", { fg = colors.deleted, bg = colors.dark_bg })
hl("DiffText", { fg = colors.accent, bg = colors.line_hl })
...
-- Telescope
hl("TelescopeNormal", { fg = colors.fg, bg = colors.widget_bg })
hl("TelescopeBorder", { fg = colors.border, bg = colors.widget_bg })
hl("TelescopePromptNormal", { fg = colors.variable, bg = colors.dark_bg })
hl("TelescopePromptBorder", { fg = colors.accent, bg = colors.dark_bg })
hl("TelescopePromptTitle", { fg = colors.accent, bg = colors.dark_bg, bold = true })
...
hl("SnacksPicker", { fg = colors.fg, bg = colors.widget_bg })
hl("SnacksPickerBorder", { fg = colors.border, bg = colors.widget_bg })
hl("SnacksPickerNormal", { fg = colors.fg, bg = colors.widget_bg })
hl("SnacksPickerBox", { fg = colors.border, bg = colors.widget_bg })

hl("SnacksPickerInput", { fg = colors.fg, bg = colors.dark_bg })
hl("SnacksPickerInputNormal", { fg = colors.fg, bg = colors.dark_bg })
hl("SnacksPickerInputBorder", { fg = colors.accent, bg = colors.dark_bg })
...
hl("SnacksPickerList", { fg = colors.fg, bg = colors.sidebar_bg })
hl("SnacksPickerListNormal", { fg = colors.fg, bg = colors.sidebar_bg })
hl("SnacksPickerListBorder", { fg = colors.border, bg = colors.sidebar_bg })
...
hl("SnacksPickerDir", { fg = colors.class })
...
hl("NeoTreeWinSeparator", { fg = colors.border, bg = colors.sidebar_bg })
hl("NvimTreeNormal", { fg = colors.fg, bg = colors.sidebar_bg })
hl("NvimTreeNormalNC", { fg = colors.fg, bg = colors.sidebar_bg })
hl("NvimTreeWinSeparator", { fg = colors.border, bg = colors.sidebar_bg })
hl("NvimTreeFolderName", { fg = colors.class })
hl("NvimTreeOpenedFolderName", { fg = colors.class, bold = true })
